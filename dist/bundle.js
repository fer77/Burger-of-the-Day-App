...
function fetch(path) {
  var url = _constants.BASE_URI + "/" + path;
  ...
  return new Promise(function (resolve, reject) {
    ...
    request.onerror = function () {
      reject(new Error("Error fetching menu item"));
    };
...
_burger2.default.findAll().then(_ui2.default.burgerOfTheDay);

},{"./burger":4,"./ui":6}],4:[function(require,module,exports){
"use strict";
...
var Burger = { findAll: findAll };

function findAll() {
  return _api2.default.fetch("burger");
}
...
var ui = {
  burgerOfTheDay: function burgerOfTheDay(burgers) {

    var target = document.querySelector(".container");

    var postBurgers = burgers.map(function (burger) {
...
function menuItem(title, ingridient) {
  var burgerTitle = _xssFilters2.default.inHTMLData(title);
  var ingredients = _xssFilters2.default.inHTMLData(ingridient);
